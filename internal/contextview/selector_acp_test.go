...
func TestACPSelectorRetainsAllUnbudgetedFragments(t *testing.T) {
	...
	frags := []contextfrag.ContextFrag{
		contextfrag.TextFrag(contextfrag.TextFragInput{
			ID: "system", Kind: contextfrag.KindACPContext, Role: sdk.MessageRoleSystem,
	...
	result := selector.Select(frags, selector.ProfileFor(contextfrag.IntentACPRuntimePrompt), BudgetEnvelope{})
