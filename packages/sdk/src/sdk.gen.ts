 ...
 */
export const getModelsMemory = <ThrowOnError extends boolean = false>(options?: Options<GetModelsMemoryData, ThrowOnError>) => (options?.client ?? client).get<GetModelsMemoryResponses, GetModelsMemoryErrors, ThrowOnError>({ url: '/models/memory', ...options });
